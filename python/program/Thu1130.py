# -*- coding: utf-8 -*-
"""
Created on Thu Nov 30 15:04:13 2023
...
rmse = lambda y1,y2: np.sqrt(sum((y1-y2)**2)/len(y1))

print('2차식 모델 rmse = ', rmse(y, y2))

P = np.polyfit(x,y,1)
y1 = np.polyval(P,x)

plt.plot(x,y1,'--g')
print('1차식 모델 rmse = ', rmse(y, y1))

print(rmse(y, y2)>rmse(y, y1))
#2차식 채택
